...
public class TelefoneClienteDAO implements TelefoneDAO {

    @Override
    public void inserir(Connection con, Telefone telefone, int idPessoa) throws Exception {
        String sql = "INSERT INTO TelefoneCliente (numero, idDdi, idDdd, idCliente) VALUES (?, ?, ?, ?) RETURNING idTelefone";
